...
const Contact = () => {
  ...
  return (
    <>
      <section ref={sectionRef} id="contact" className="relative min-h-screen flex flex-col pt-20 md:pt-0 pb-0 bg-[#0F0B14] overflow-hidden" style={{
        perspective: "1500px"
      }}>
        ...
        {isPuzzleOpen && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-0">
            ...
            <motion.div
              ...
              className="relative w-[92vw] max-w-md bg-[#140D1B] border border-[#A855C5]/30 p-5 md:p-8 rounded-2xl md:rounded-3xl shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden"
            >
              ...
              <div className="relative z-10 text-center mb-5 md:mb-8">
                <span className="text-[#c79a40] tracking-[0.5em] uppercase text-[9px] md:text-[10px] font-bold mb-2 md:mb-3 block">SECURITY CHALLENGE</span>
                <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tighter">ALIGN THE <span className="text-[#A855C5]">SHARD</span></h3>
                <p className="text-[10px] md:text-xs text-white/40 mt-1 md:mt-2 tracking-wide uppercase font-medium">Slide the fragment to restore the symbol</p>
              </div>

              {/* Ritual Snap (Pattern Match Slide) */}
              <div className="space-y-6 md:space-y-8">
                <div className="relative h-32 md:h-48 bg-black/80 rounded-xl md:rounded-2xl border border-white/5 flex items-center justify-center group/puzzle overflow-hidden select-none">
                  ...
                  <motion.div
                    className="absolute z-20 w-20 h-20 md:w-24 md:h-24 flex items-center justify-center pointer-events-none"
                    style={{
                      left: leftPos,
                      translateX: "-50%"
                    }}
                  >
                    <Logo className="w-12 h-12 md:w-20 md:h-20 text-[#A855C5] filter brightness-125" />
                  </motion.div>
                </div>
